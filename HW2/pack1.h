...
void iterate_func(char board_size[12][12],const int& size);//This function attend '*' char to a board_size arrey 
													//The aim is to control arrey easily 
	
void iterate_func1(char temp_arrey[12][12],const int& size);//This function attend '*' char to a temp_arrey 
...
void iterate_func2(char bridge[20][20],const int& size);//This function attend '*' char to a bridge arrey 
												//To control the bridge situations 
void print_function(char board_size[12][12],const int& size);//This function is printing the current board_size arrey to see current situation


void play_user2(char board_size[12][12],const int& size);//This function control the ending situation and make move for both of user1 and user2
void move_inboard_user1(char board_size[12][12],const int& size);//This function control the moving of user 1 is valid or not if moving is valid we save it to the boardsize arrey
void move_inboard_user2(char board_size[12][12],const int& size);//This function control the moving of user 2 is valid or not if moving is valid we save it to the boardsize arrey
bool end_game_user1(char board_size[12][12],const int& size);//In this function we are controlling the game is end or not for user 1
...
bool end_game_user2(char board_size[12][12],const int& size);//In this function we are controlling the game is end or not for user 2
...
void fill_blanks(char board_size[12][12],const int size,int lastp_x,int lastp_y,char bridge[20][20]);
